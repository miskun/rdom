//! Caret position math — the reverse of hit-testing. A pure function
//! of the inline layout: paint draws the caret with it, and the runtime
//! (vertical caret movement, caret reveal) re-uses it; the public
//! `runtime::editing::caret::cell_of_position` path re-exports it.
//!
...
use super::{InlineFragment, InlineLayout, inline_flow_for_text, inline_flow_layout};
